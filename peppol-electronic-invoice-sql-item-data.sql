...
(
    ...
    `InvoiceLineItemAdditionalItemPropertyValue`                                 varchar(25) DEFAULT NULL,   --<cbc/cac:InvoiceLineItemAdditionalItemProperty/cac:InvoiceLineItem/cac:InvoiceLine> "Black"
    `InvoiceLinePricePriceAmount`                                                varchar(25) DEFAULT NULL,   --currencyID="SGD"`<cbc/cac:InvoiceLinePricePrice/cac:InvoiceLine> "90.00"
    `InvoiceLinePriceBaseQuantity`                                 　            varchar(15) DEFAULT NULL,    --unitCode="H87"<cbc/cac:InvoiceLinePricePrice/cac:InvoiceLine> "1"
    PRIMARY KEY (`UBLVersionID`, `CustomizationID`, `ProfileID`, `ID`, `InvoiceLineID`),
